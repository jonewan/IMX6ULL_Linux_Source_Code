...
#define IOMUX_SW_MUX_CTL_BASE				(0X020E0044)
#define IOMUX_SW_PAD_CTL_BASE				(0X020E0204)
...
/*
*	Defination of CCM register struct
*/
typedef struct{
	volatile unsigned int	CCM_CCR;
	volatile unsigned int	CCM_CCDR;
	volatile unsigned int	CCM_CSR;
	volatile unsigned int	CCM_CCSR;
	volatile unsigned int	CCM_CACRR;
	volatile unsigned int	CCM_CBCDR;
	volatile unsigned int	CCM_CBCMR;
	volatile unsigned int	CCM_CSCMR1;
	volatile unsigned int	CCM_CSCMR2;
	volatile unsigned int	CCM_CSCDR1;
	volatile unsigned int	CCM_CS1CDR;
	volatile unsigned int	CCM_CS2CDR;
	volatile unsigned int	CCM_CDCDR;
	volatile unsigned int	CCM_CHSCCDR;
	volatile unsigned int	CCM_CSCDR2;
	volatile unsigned int	CCM_CSCDR3;
	volatile unsigned int RESERV1[2];
	volatile unsigned int	CCM_CDHIPR;
	volatile unsigned int RESERV2[2];
	volatile unsigned int	CCM_CLPCR;
	volatile unsigned int	CCM_CISR;
	volatile unsigned int	CCM_CIMR;
	volatile unsigned int	CCM_CCOSR;
	volatile unsigned int	CCM_CGPR;
	...
	volatile unsigned int RESERV3[1];
	volatile unsigned int	CCM_CMEOR;
} CCM_Type;
...
#define IOMUX_SW_MUX		((IOMUX_SW_MUX_Type *)IOMUX_SW_MUX_CTL_BASE)
#define IOMUX_SW_PAD		((IOMUX_SW_PAD_Type *)IOMUX_SW_PAD_CTL_BASE)
